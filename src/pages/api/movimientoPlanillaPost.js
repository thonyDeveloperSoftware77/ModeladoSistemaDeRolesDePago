export default async function handler(req, res) {
  ...
  const {conceptos, prioridad, tipooperacion, cuenta1, cuenta2, cuenta3, cuenta4,MovimientoExcepcion1,  
